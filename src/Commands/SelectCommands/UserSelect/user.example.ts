...
/**
 * If a user-select-component is pressed,
 * the according file will be searched and executed automatically.
 *
 * @example
 * If you have a user-select-component with custom ID 'ping';
 * The code will look for "src/Commands/SelectCommands/UserSelect/ping.js"
 *
 * If you have a user-select-component with custom ID 'ping/user',
 * and it has a subcommand with the name 'user';
 * The code will look for "src/Commands/SelectCommands/UserSelect/ping/user.js"
 *
 ...
 * and executed in file "src/Commands/SelectCommands/UserSelect/ping.js"
 */
