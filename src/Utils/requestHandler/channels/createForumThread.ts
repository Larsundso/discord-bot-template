...
export default async (
 ...
 if (!canCreateForumThread(channel.id, channel.guild.members.me)) {
 ...
 */
export const canCreateForumThread = (channelId: string, me: Discord.GuildMember | null) =>
 me && me.permissionsIn(channelId).has(Discord.PermissionFlagsBits.SendMessages);
