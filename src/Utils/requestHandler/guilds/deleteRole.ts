...
export default async (guild: Discord.Guild, roleId: string, reason?: string) => {
 ...
 if (!canDeleteRole(guild.members.me, roleId)) {
 ...
 return API.guilds.deleteRole(guild.id, roleId, { reason }).catch((e) => {
 ...
 */
export const canDeleteRole = (me: Discord.GuildMember | null, roleId: string) =>
 me &&
