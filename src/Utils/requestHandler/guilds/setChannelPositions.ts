...
export default async (
 ...
 if (!canSetChannelPositions(guild.members.me)) {
 ...
 return API.guilds.setChannelPositions(guild.id, body, { reason }).catch((e) => {
 ...
 */
export const canSetChannelPositions = (me: Discord.GuildMember | null) =>
 me && me.permissions.has(Discord.PermissionFlagsBits.ManageChannels);
