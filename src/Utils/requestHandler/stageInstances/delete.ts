...
export default async (guild: Discord.Guild, channelId: string, reason?: string) => {
 ...
 if (!canDelete(guild.members.me, channelId)) {
 ...
 return API.stageInstances.delete(channelId, { reason }).catch((e) => {
 ...
 */
export const canDelete = (me: Discord.GuildMember | null, channelId: string) =>
